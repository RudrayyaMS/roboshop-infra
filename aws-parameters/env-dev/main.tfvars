parameters = [
  ##frontend service
  { name= "dev.frontend.catalogue_url" , value = "http://catalogue-dev.devopsm71.online/" , type= "String"},
  ...
  { name= "dev.user.mongo_url" ,   value = "mongodb://mongo-dev.devopsm71.online:27017/catalogue" , type= "String"},
  ## shipping service
